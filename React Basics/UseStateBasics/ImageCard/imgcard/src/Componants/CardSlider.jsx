...
function CardSlider() {
    ...
    <div className=''>
        ...
        <div className="img bg-red-300 h-64 w-96 rounded-md flex items-end justify-center overflow-clip relative" >
            ...
            <img className={`overflow-hidden absolute z-0 transition-transform delay-200 ${!val? '-translate-x-[0%]' : '-translate-x-[100%]'}`} src="https://images.unsplash.com/photo-1544894079-e81a9eb1da8b?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
